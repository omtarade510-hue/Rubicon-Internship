...
* To gain hands-on experience with coding practices and project structuring
...
* `cal.py` – Basic calculator implementation
* `T1.py` to `T8.py` – Practice-based programs covering various concepts
* Additional files demonstrating file handling and logic building
...
```bash
git clone https://github.com/omtarade510-hue/Rubicon-Internship.git
```

2. Navigate to the project folder:

```bash
cd Rubicon-Internship
```
...
* Exposure to real-time coding practices
